        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-5 offset-lg-1">
                    <div class="sign-register-area" style="background-image: url(assets/img/Car21.png)">
                        <div class="sign-register-area-inner">
                            <h4 class="title">Existing User</h4>
                            <p>Already Have an Account Sign In.</p>
                            <div class="main-btn-wrap text-center">
                                <a href="signin" class="main-btn white uppercase">SIGN IN</a>
                            </div>
                        </div>
                    </div>
                    <!--// Register Area-->
                ...
                <div class="col-lg-5">
                    <div class="sign-in-area">
                        ...
                        <form action="">
                            ...
                            <label for="email" class="padding-top-20">Phone Number</label>
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text">
                                ...
                                <input type="email" class="form-control" id="email" placeholder="Enter Your Phone Number">
                            </div>
                            <!--// Email-->
                            ...
                            <label for="confirm_password" class="padding-top-20">Confirm Password</label>
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text">
                                        <i class="icon flaticon-lock"></i>
                            ...
                            <div class="form-bottom-area padding-top-30">
                                <div class="remember-me">
                                    ...
                                    <a href="terms">Agreed to Terms & Conditions</a>
                                </div>
                                
                            </div>

                            <div class="main-btn-wrap text-center padding-top-40">
                                <input type="submit" class="main-btn  uppercase" value="SIGN UP">
                            </div>
