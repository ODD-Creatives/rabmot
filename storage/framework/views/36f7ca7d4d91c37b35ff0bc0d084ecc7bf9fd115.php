<nav class="navbar navbar-expand-lg navbar-light bg-light shadow-sm fixed-top">
            <div class="container" id="div-nav">
                ...
                <div class="collapse navbar-collapse " id="navbarSupportedContent">
                    <ul class="navbar-nav  mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link a-nav nav-b" href="air">Air</a> 
                        </li>
                        <li class="nav-item">
                                    ...
                                    <div class="col-6">
                                        <li>
                                            <a class="dropdown-item" href="#">
                                                <div class="row">
                                                    <div class="col-3"><i class="fa fa-home fa-lg mb-1 i-nav"></i></div>
                                                    <div class="col-9">
                                        ...
                                        <li>
                                            <a class="dropdown-item" href="#">
                                                <div class="row">
                                                    <div class="col-3"><i class="fa fa-home fa-lg mb-1 i-nav"></i></div>
                                                    <div class="col-9">
                                                        <p class="product-nav">Visa Assistance </p>
                                                        <span class="product-nav-span">Apply for a particular
                                                            visa</span>
                                        ...
                                        <li>
                                            <a class="dropdown-item" href="#">
                                                <div class="row">
                                                    <div class="col-3"><i class="fa fa-home fa-lg mb-1 i-nav"></i></div>
                                                    <div class="col-9">
                                                        <p class="product-nav">Yellow Card </p>
                                                        <span class="product-nav-span">Get your yellow card with
                                                            ease</span>
                                        ...
                                        <a class="dropdown-item" href="aboutus">
                                            <div class="row">
                                                ...
                                                <div class="col-9">
                                                    ...
                                                    <span class="product-nav-span">Check back later</span>
        ...
        </nav><?php /**PATH C:\xampp\htdocs\laravel\travelwheel\resources\views/air/nav.blade.php ENDPATH**/ ?>