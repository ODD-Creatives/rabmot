<nav class="navbar navbar-expand-lg navbar-light bg-light shadow-sm fixed-top">
            <div class="container" id="div-nav">
                ...
                <div class="collapse navbar-collapse " id="navbarSupportedContent">
                    <ul class="navbar-nav  mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link a-nav text-muted" href="#">Land</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link a-nav text-muted" href="#">Water</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link a-nav text-muted" href="#">Rail</a>
                        </li>     
        ...
        </nav><?php /**PATH C:\xampp\htdocs\laravel\travelwheel\resources\views/air/nav-a.blade.php ENDPATH**/ ?>