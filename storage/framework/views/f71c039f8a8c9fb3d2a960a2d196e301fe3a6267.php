  ...
  <!-- Vendors JS -->
  <script src="assetsU/assets/vendor/libs/apex-charts/apexcharts.js"></script>

  <!-- Main JS -->
  <script src="assetsU/assets/js/main.js"></script>

  <!-- Page JS -->
  <script src="assetsU/assets/js/dashboards-analytics.js"></script>

  <!-- Place this tag in your head or just before your close body tag. -->
  <script async defer src="https://buttons.github.io/buttons.js"></script>
</body>

</html><?php /**PATH C:\xampp\htdocs\laravel\travelwheel\resources\views/footerU.blade.php ENDPATH**/ ?>