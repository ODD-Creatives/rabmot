                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input id="email" type="email" placeholder="Enter your email or username" class="form-control <?php $__errorArgs = ['email'];
...
</html><?php /**PATH C:\xampp\htdocs\laravel\travelwheel\resources\views/auth/login.blade.php ENDPATH**/ ?>