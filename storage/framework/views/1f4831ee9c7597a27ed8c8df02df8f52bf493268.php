<nav class="navbar navbar-expand-lg navbar-light bg-light shadow-sm fixed-top">
            <div class="container" id="div-nav">
                ...
                <div class="collapse navbar-collapse " id="navbarSupportedContent">
                    <ul class="navbar-nav  mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link a-nav nav-b" href="water">Water</a>
                        </li>
                        <li class="nav-item">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                    ...
                    <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-a">
                                <div class="row">
                                    ...
                                    <li>
                                        <a class="dropdown-item" href="#">
                                            <div class="row">
                                                ...
                                                <div class="col-9">
                                                    <p class="product-nav">Comming Soon </p>
        ...
        </nav><?php /**PATH C:\xampp\htdocs\laravel\travelwheel\resources\views/water/nav.blade.php ENDPATH**/ ?>